...
private:
  ...
  MonitorElement* meEle_dt_general_pT_1_eta_1;
  MonitorElement* meEle_dt_general_pT_2_eta_1;
  MonitorElement* meEle_dt_general_pT_3_eta_1;
  MonitorElement* meEle_dt_general_pT_4_eta_1;
  MonitorElement* meEle_dt_general_pT_5_eta_1;
  MonitorElement* meEle_dt_general_pT_6_eta_1;
  MonitorElement* meEle_dt_general_pT_7_eta_1;
  MonitorElement* meEle_dt_general_pT_8_eta_1;
  MonitorElement* meEle_dt_general_pT_9_eta_1;

  MonitorElement* meEle_dt_general_pT_1_eta_2;
  MonitorElement* meEle_dt_general_pT_2_eta_2;
  MonitorElement* meEle_dt_general_pT_3_eta_2;
  MonitorElement* meEle_dt_general_pT_4_eta_2;
  MonitorElement* meEle_dt_general_pT_5_eta_2;
  MonitorElement* meEle_dt_general_pT_6_eta_2;
  MonitorElement* meEle_dt_general_pT_7_eta_2;
  MonitorElement* meEle_dt_general_pT_8_eta_2;
  MonitorElement* meEle_dt_general_pT_9_eta_2;

  MonitorElement* meEle_dt_general_pT_1_eta_3;
  MonitorElement* meEle_dt_general_pT_2_eta_3;
  MonitorElement* meEle_dt_general_pT_3_eta_3;
  MonitorElement* meEle_dt_general_pT_4_eta_3;
  MonitorElement* meEle_dt_general_pT_5_eta_3;
  MonitorElement* meEle_dt_general_pT_6_eta_3;
  MonitorElement* meEle_dt_general_pT_7_eta_3;
  MonitorElement* meEle_dt_general_pT_8_eta_3;
  MonitorElement* meEle_dt_general_pT_9_eta_3;

  MonitorElement* meEle_dt_general_pT_1_eta_4;
  MonitorElement* meEle_dt_general_pT_2_eta_4;
  MonitorElement* meEle_dt_general_pT_3_eta_4;
  MonitorElement* meEle_dt_general_pT_4_eta_4;
  MonitorElement* meEle_dt_general_pT_5_eta_4;
  MonitorElement* meEle_dt_general_pT_6_eta_4;
  MonitorElement* meEle_dt_general_pT_7_eta_4;
  MonitorElement* meEle_dt_general_pT_8_eta_4;
  MonitorElement* meEle_dt_general_pT_9_eta_4;

  MonitorElement* meEle_dt_general_pT_1_eta_5;
  MonitorElement* meEle_dt_general_pT_2_eta_5;
  MonitorElement* meEle_dt_general_pT_3_eta_5;
  MonitorElement* meEle_dt_general_pT_4_eta_5;
  MonitorElement* meEle_dt_general_pT_5_eta_5;
  MonitorElement* meEle_dt_general_pT_6_eta_5;
  MonitorElement* meEle_dt_general_pT_7_eta_5;
  MonitorElement* meEle_dt_general_pT_8_eta_5;
  MonitorElement* meEle_dt_general_pT_9_eta_5;
  ...
  std::vector<MonitorElement*> pT_eta_1_list;
  std::vector<MonitorElement*> pT_eta_2_list;
  std::vector<MonitorElement*> pT_eta_3_list;
  std::vector<MonitorElement*> pT_eta_4_list;
  std::vector<MonitorElement*> pT_eta_5_list;
};
...
void MtdEleIsoValidation::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if(dt_sig_vtx_ && dt_sig_track_){
    dt_sig_track_ = false;
    std::cout << "Both timing cut types chosen!!! Fix this at the configuration setup. Default timing wrt. vtx chosen" << std::endl;
  }
          ...
          if(dt_distributions_){
            ...
            for(long unsigned int i = 0; i < (pT_bins_dt_distrb.size()-1); i++){
              ...
              if(ele.pt() > pT_bins_dt_distrb[i] && ele.pt() < pT_bins_dt_distrb[i+1]){
                ...
                if(fabs(ele.eta()) < eta_bins_dt_distrib[1]){
                  pT_eta_1_list[i]->Fill(dt_sigTrk);
                }
                
                if(fabs(ele.eta()) >= eta_bins_dt_distrib[1] && fabs(ele.eta()) < eta_bins_dt_distrib[2]){
                  pT_eta_2_list[i]->Fill(dt_sigTrk);
                }

                if(fabs(ele.eta()) >= eta_bins_dt_distrib[2] && fabs(ele.eta()) < eta_bins_dt_distrib[3]){
                  pT_eta_3_list[i]->Fill(dt_sigTrk);
                }

                if(fabs(ele.eta()) >= eta_bins_dt_distrib[3] && fabs(ele.eta()) < eta_bins_dt_distrib[4]){
                  pT_eta_4_list[i]->Fill(dt_sigTrk);
                }

                if(fabs(ele.eta()) >= eta_bins_dt_distrib[4] && fabs(ele.eta()) < eta_bins_dt_distrib[5]){
                  pT_eta_5_list[i]->Fill(dt_sigTrk);
                }
              }
            }
          ...
          if(dt_distributions_){
            ...
            for(long unsigned int i = 0; i < (pT_bins_dt_distrb.size()-1); i++){
              ...
              if(ele.pt() > pT_bins_dt_distrb[i] && ele.pt() < pT_bins_dt_distrb[i+1]){
                ...
                if(fabs(ele.eta()) < eta_bins_dt_distrib[1]){
                  pT_eta_1_list[i]->Fill(dt_vtx);
                }
                
                if(fabs(ele.eta()) > eta_bins_dt_distrib[1] && fabs(ele.eta()) < eta_bins_dt_distrib[2]){
                  pT_eta_2_list[i]->Fill(dt_vtx);
                }

                if(fabs(ele.eta()) > eta_bins_dt_distrib[2] && fabs(ele.eta()) < eta_bins_dt_distrib[3]){
                  pT_eta_3_list[i]->Fill(dt_vtx);
                }

                if(fabs(ele.eta()) > eta_bins_dt_distrib[3] && fabs(ele.eta()) < eta_bins_dt_distrib[4]){
                  pT_eta_4_list[i]->Fill(dt_vtx);
                }

                if(fabs(ele.eta()) > eta_bins_dt_distrib[4] && fabs(ele.eta()) < eta_bins_dt_distrib[5]){
                  pT_eta_5_list[i]->Fill(dt_vtx);
                }
              }
            }
          } // End of optional dt distributions plots
...
void MtdEleIsoValidation::bookHistograms(DQMStore::IBooker& ibook, edm::Run const& run, edm::EventSetup const& iSetup) {
  ...
  meEle_no_dt_check_ = ibook.book1D("Track_dt_info_check",
  ...
  meEle_dt_general_pT_1 = ibook.book1D("Iso_track_dt_general_pT_10_20", "Iso cone track dt distribution in pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2 = ibook.book1D("Iso_track_dt_general_pT_20_30", "Iso cone track dt distribution in pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3 = ibook.book1D("Iso_track_dt_general_pT_30_40", "Iso cone track dt distribution in pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4 = ibook.book1D("Iso_track_dt_general_pT_40_50", "Iso cone track dt distribution in pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5 = ibook.book1D("Iso_track_dt_general_pT_50_60", "Iso cone track dt distribution in pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6 = ibook.book1D("Iso_track_dt_general_pT_60_70", "Iso cone track dt distribution in pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7 = ibook.book1D("Iso_track_dt_general_pT_70_80", "Iso cone track dt distribution in pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8 = ibook.book1D("Iso_track_dt_general_pT_80_90", "Iso cone track dt distribution in pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9 = ibook.book1D("Iso_track_dt_general_pT_90_100", "Iso cone track dt distribution in pT bin 90-100 GeV ", 100, 0, 1);

  meEle_dt_general_eta_1 = ibook.book1D("Iso_track_dt_general_eta_0_05", "Iso cone track dt distribution in eta bin 0.0-0.5 ", 100, 0, 1);
  meEle_dt_general_eta_2 = ibook.book1D("Iso_track_dt_general_eta_05_10", "Iso cone track dt distribution in eta bin 0.5-1.0 ", 100, 0, 1);
  meEle_dt_general_eta_3 = ibook.book1D("Iso_track_dt_general_eta_10_15", "Iso cone track dt distribution in eta bin 1.0-1.5 ", 100, 0, 1);
  meEle_dt_general_eta_4 = ibook.book1D("Iso_track_dt_general_eta_15_20", "Iso cone track dt distribution in eta bin 1.5-2.0 ", 100, 0, 1);
  meEle_dt_general_eta_5 = ibook.book1D("Iso_track_dt_general_eta_20_24", "Iso cone track dt distribution in eta bin 2.0-2.4 ", 100, 0, 1);

  meEle_dt_general_pT_1_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_10_20", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_20_30", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_30_40", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_40_50", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_50_60", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_60_70", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_70_80", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_80_20", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9_eta_1 = ibook.book1D("Iso_track_dt_eta_00_05_pT_90_100", "Iso cone track dt distribution in eta bin 0.0-0.5 and pT bin 90-100 GeV ", 100, 0, 1);

  meEle_dt_general_pT_1_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_10_20", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_20_30", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_30_40", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_40_50", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_50_60", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_60_70", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_70_80", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_80_20", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9_eta_2 = ibook.book1D("Iso_track_dt_eta_05_10_pT_90_100", "Iso cone track dt distribution in eta bin 0.5-1.0 and pT bin 90-100 GeV ", 100, 0, 1);

  meEle_dt_general_pT_1_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_10_20", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_20_30", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_30_40", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_40_50", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_50_60", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_60_70", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_70_80", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_80_20", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9_eta_3 = ibook.book1D("Iso_track_dt_eta_10_15_pT_90_100", "Iso cone track dt distribution in eta bin 1.0-1.5 and pT bin 90-100 GeV ", 100, 0, 1);

  meEle_dt_general_pT_1_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_10_20", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_20_30", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_30_40", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_40_50", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_50_60", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_60_70", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_70_80", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_80_20", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9_eta_4 = ibook.book1D("Iso_track_dt_eta_15_20_pT_90_100", "Iso cone track dt distribution in eta bin 1.5-2.0 and pT bin 90-100 GeV ", 100, 0, 1);

  meEle_dt_general_pT_1_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_10_20", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 10-20 GeV ", 100, 0, 1);
  meEle_dt_general_pT_2_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_20_30", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 20-30 GeV ", 100, 0, 1);
  meEle_dt_general_pT_3_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_30_40", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 30-40 GeV ", 100, 0, 1);
  meEle_dt_general_pT_4_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_40_50", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 40-50 GeV ", 100, 0, 1);
  meEle_dt_general_pT_5_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_50_60", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 50-60 GeV ", 100, 0, 1);
  meEle_dt_general_pT_6_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_60_70", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 60-70 GeV ", 100, 0, 1);
  meEle_dt_general_pT_7_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_70_80", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 70-80 GeV ", 100, 0, 1);
  meEle_dt_general_pT_8_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_80_20", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 80-90 GeV ", 100, 0, 1);
  meEle_dt_general_pT_9_eta_5 = ibook.book1D("Iso_track_dt_eta_20_24_pT_90_100", "Iso cone track dt distribution in eta bin 2.0-2.4 and pT bin 90-100 GeV ", 100, 0, 1);
  ...
  pT_eta_1_list = {meEle_dt_general_pT_1_eta_1,
                   meEle_dt_general_pT_2_eta_1,
                   meEle_dt_general_pT_3_eta_1,
                   meEle_dt_general_pT_4_eta_1,
                   meEle_dt_general_pT_5_eta_1,
                   meEle_dt_general_pT_6_eta_1,
                   meEle_dt_general_pT_7_eta_1,
                   meEle_dt_general_pT_8_eta_1,
                   meEle_dt_general_pT_9_eta_1};

  pT_eta_2_list = {meEle_dt_general_pT_1_eta_2,
                   meEle_dt_general_pT_2_eta_2,
                   meEle_dt_general_pT_3_eta_2,
                   meEle_dt_general_pT_4_eta_2,
                   meEle_dt_general_pT_5_eta_2,
                   meEle_dt_general_pT_6_eta_2,
                   meEle_dt_general_pT_7_eta_2,
                   meEle_dt_general_pT_8_eta_2,
                   meEle_dt_general_pT_9_eta_2};

  pT_eta_3_list = {meEle_dt_general_pT_1_eta_3,
                   meEle_dt_general_pT_2_eta_3,
                   meEle_dt_general_pT_3_eta_3,
                   meEle_dt_general_pT_4_eta_3,
                   meEle_dt_general_pT_5_eta_3,
                   meEle_dt_general_pT_6_eta_3,
                   meEle_dt_general_pT_7_eta_3,
                   meEle_dt_general_pT_8_eta_3,
                   meEle_dt_general_pT_9_eta_3};

  pT_eta_4_list = {meEle_dt_general_pT_1_eta_4,
                   meEle_dt_general_pT_2_eta_4,
                   meEle_dt_general_pT_3_eta_4,
                   meEle_dt_general_pT_4_eta_4,
                   meEle_dt_general_pT_5_eta_4,
                   meEle_dt_general_pT_6_eta_4,
                   meEle_dt_general_pT_7_eta_4,
                   meEle_dt_general_pT_8_eta_4,
                   meEle_dt_general_pT_9_eta_4};

  pT_eta_5_list = {meEle_dt_general_pT_1_eta_5,
                   meEle_dt_general_pT_2_eta_5,
                   meEle_dt_general_pT_3_eta_5,
                   meEle_dt_general_pT_4_eta_5,
                   meEle_dt_general_pT_5_eta_5,
                   meEle_dt_general_pT_6_eta_5,
                   meEle_dt_general_pT_7_eta_5,
                   meEle_dt_general_pT_8_eta_5,
                   meEle_dt_general_pT_9_eta_5};
...
void MtdEleIsoValidation::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<bool>("option_dtToPV", true);
  desc.add<bool>("option_dtToTrack", false);
  desc.add<bool>("option_dtDistributions", true);
